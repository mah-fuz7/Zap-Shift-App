...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-base-100 shadow-sm relative z-50">
      ...
      <div className="navbar-center gap-3 hidden lg:flex">{navLinks}</div>
      ...
      <div className="navbar-end flex gap-2 md:gap-3">
        {user ? (
          ...
          <>
            <Link
              to="/login"
              className="text-gray-500 px-3 py-1.5 md:px-6 md:py-2.5 rounded-xl md:rounded-2xl border-2 border-gray-500 font-semibold hover:bg-primary hover:text-white transition text-xs md:text-base"
            >
              Sign In
            </Link>
            ...
            <Link
              to="/signup"
              className="pl-3 pr-1 py-1 md:pl-4 md:py-1.5 rounded-xl md:rounded-2xl bg-primary font-semibold hover:brightness-90 transition flex items-center gap-1.5 md:gap-3 text-xs md:text-base"
            >
              Sign Up
